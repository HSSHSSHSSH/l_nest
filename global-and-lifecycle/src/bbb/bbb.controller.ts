  ...
  implements OnModuleDestroy, BeforeApplicationShutdown, OnApplicationShutdown
{
  ...
  onModuleDestroy() {
    console.log('bbbb controller onModuleDestroy');
  }

  beforeApplicationShutdown(signal: string) {
    console.log('bbbb controller beforeApplicationShutdown', signal);
  }

  onApplicationShutdown() {
    console.log('bbbb controller onApplicationShutdown');
  }
